...
?>
			  					<!--<form class="form-horizontal" role="form">-->
			  						...
			  						echo form_open_multipart('contract/save',$attributes);
			  						?>
			  					<div class="form-group">
								    <label for="contract_name" class="col-sm-2 control-label">Contract Name<span class="text-danger">*</span></label>
								    <div class="col-sm-10">
								      <input type="text" class="form-control input-sm" id="contract_name" placeholder="Contract Name" name="contract_name">
								    </div>
								  </div>
								  <div class="form-group">
						...
						<div class="form-group">
								    ...
								    <div class="col-sm-10">
								      <input type="date" class="form-control input-sm" id="effective_date" placeholder="Effective Date" name="effective_date">
								    </div>
								  </div>
							...
							<div class="form-group">
								    ...
								    <div class="col-sm-10">
								      <input type="date" class="form-control input-sm" id="end_date" placeholder="Expiry Date" name="end_date">
								    </div>
								  </div>
			  					...
			  					<div class="form-group">
								    ...
								    <div class="col-sm-10">
								      <input type="text" class="form-control input-sm" id="organisation" placeholder="Organisation" name="organisation">
								    </div>
								  </div>
								  ...
								  <div class="form-group">
								    ...
								    <div class="col-sm-10">
								      <input type="text" class="form-control input-sm" id="contact_person" placeholder="Contact Person" name="contact_person">
								    </div>
								  </div>
								  ...
								  <div class="form-group">
								    ...
								    <div class="col-sm-10">
								      <input type="text" class="form-control input-sm" id="phone" placeholder="Phone" name="phone">
								    </div>
								  </div>
								 ...
								 <div class="form-group">
								    ...
								    <div class="col-sm-10">
								      <textarea class="form-control input-sm" placeholder="Address" rows="3" name="address"></textarea>
								    </div>
								  </div>
